...
abstract class $UserEntitieCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String fullName, String email, String phone});
}
...
class _$_UserEntitie extends _UserEntitie {
  ...
  @override
  String toString() {
    return 'UserEntitie(id: $id, fullName: $fullName, email: $email, phone: $phone)';
  }
...
abstract class _UserEntitie extends UserEntitie {
  const factory _UserEntitie(
      ...
      required final String phone}) = _$_UserEntitie;
